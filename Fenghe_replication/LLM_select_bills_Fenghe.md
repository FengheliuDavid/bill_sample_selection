...
- `llm_input_metadata_2726.csv` — 2,726 rows × 7 columns: `bill_id`, `congress_term`, `introduced_at`, `policy_area`, `subjects`, `official_title`, `short_title`
- `llm_input_texts_2726/` — 5,452 `.txt` files, two per bill: `{bill_id}_summary.txt` and `{bill_id}_full_text.txt`
...
| `llm_input_metadata_2726.csv` | Metadata for 2,726 bills (no text) |
| `llm_input_texts_2726/` | Per-bill summary and full text `.txt` files (gitignored) |
