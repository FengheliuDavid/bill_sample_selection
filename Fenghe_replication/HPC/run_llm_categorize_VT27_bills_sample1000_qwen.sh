#!/bin/bash
#SBATCH --job-name=bill_VT27_s5k_qwen
#SBATCH --array=1-5%5
...
#SBATCH --mem=32G
#SBATCH --time=6:00:00
#SBATCH --output=llm_bill_VT27_category_outputs_2010sample5000_07_15_qwen/logs/task_%j_%a.out
#SBATCH --error=llm_bill_VT27_category_outputs_2010sample5000_07_15_qwen/logs/task_%j_%a.err

WORKDIR=/gpfs/home/fl488/process_bill_text
mkdir -p $WORKDIR/llm_bill_VT27_category_outputs_2010sample5000_07_15_qwen/logs
cd $WORKDIR
...
conda activate llama_cuda_qwen
...
python 8_llm_categorize_VT27_bills_sample1000_qwen.py
