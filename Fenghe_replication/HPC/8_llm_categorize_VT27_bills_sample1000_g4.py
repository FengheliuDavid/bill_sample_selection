...
# Classify 5,000 sampled bills using Gemma 4 31B (Q4_K_M) + prompt 06_29.
...
OUTPUT_DIR     = SCRIPT_DIR / "llm_bill_VT27_category_outputs_sample5000_06_29_g4"
MODEL_PATH     = "/gpfs/home/fl488/process_RL_sasb/models/google_gemma-4-31B-it-Q4_K_M.gguf"
...
# Prompt template
# ---------------------------------------------------------------------------
with open(SCRIPT_DIR / "8_llm_categorize_VT27_bills_prompt_06_29.md") as f:
...
llm = Llama(
    ...
    chat_format=None,   # use model's embedded Jinja2 template; defaults enable_thinking=False
    n_gpu_layers=-1,
    n_ctx=8192,
    verbose=True,
)
...
def parse_response(response: str):
    # Strip Gemma 4 thinking channel prefix: <|channel>thought\n<channel|>
    cleaned = re.sub(r"<\|channel\>.*?<channel\|>", "", response, flags=re.DOTALL)
...
for _, row in df_chunk.iterrows():
    ...
    if result is None:
        ...
        result = {"category_ids": "parse_error", "category_labels": "parse_error", "bill_type": "parse_error", "reason": ""}
