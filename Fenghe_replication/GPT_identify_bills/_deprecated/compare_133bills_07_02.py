#!/usr/bin/env python3
"""
Runs the 133 bills flagged by Qwen through both GPT-4o and Claude Sonnet,
using the prompt in HPC/8_llm_categorize_VT27_bills_prompt_07_02.md.

Input:
  - ../llm_bill_VT27_merged_sample5000_07_02_qwen.csv   (Qwen results, 133 flagged)
...
Output:
  - OUTPUT/llm_bill_VT27_compare_07_02.csv
  - OUTPUT/compare_07_02_checkpoint.csv  (auto-deleted on completion)
"""
...
QWEN_CSV   = REPO_DIR / "llm_bill_VT27_merged_sample5000_07_02_qwen.csv"
...
PROMPT_MD  = REPO_DIR / "HPC" / "8_llm_categorize_VT27_bills_prompt_07_02.md"
OUTPUT_CSV = SCRIPT_DIR / "OUTPUT" / "llm_bill_VT27_compare_07_02.csv"
CHECKPOINT = SCRIPT_DIR / "OUTPUT" / "compare_07_02_checkpoint.csv"
