...
Both models now use the same prompt (prompts are identical as of 07_10).
Changes vs 07_09: added pension/retirement clarification + DO qualify section to both prompts.
...
Input:
  ...
  - ../HPC/8_llm_categorize_VT27_bills_prompt_07_09.md
  - ../HPC/8_llm_categorize_VT27_bills_prompt_07_09_GPT.md  (now identical to above)

Output:
  - OUTPUT/llm_bill_VT27_compare_07_10.csv
  - OUTPUT/compare_07_10_checkpoint.csv  (auto-deleted on completion)
"""
...
OUTPUT_CSV = SCRIPT_DIR / "OUTPUT" / "llm_bill_VT27_compare_07_10.csv"
CHECKPOINT = SCRIPT_DIR / "OUTPUT" / "compare_07_10_checkpoint.csv"
...
# ---------------------------------------------------------------------------
# Build system prompts (both prompts are now identical)
# ---------------------------------------------------------------------------
