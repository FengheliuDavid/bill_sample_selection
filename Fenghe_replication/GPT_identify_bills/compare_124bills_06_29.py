#!/usr/bin/env python3
"""
Runs the 124 bills flagged by Qwen through both GPT-4o and Claude Sonnet,
using the prompt in 8_llm_categorize_VT27_bills_prompt_06_29.md.

Input:
  - ../llm_bill_VT27_merged_sample5000_06_29_qwen.csv   (Qwen results, 124 flagged)
  - INPUT/SAMPLE_5000/llm_input_metadata_no_prefilter.csv
  - INPUT/SAMPLE_5000/llm_input_texts_no_prefilter/
  - ../8_llm_categorize_VT27_bills_prompt_06_29.md

Output:
  - OUTPUT/llm_bill_VT27_compare_06_29.csv
  - OUTPUT/compare_06_29_checkpoint.csv  (auto-deleted on completion)
"""
...
QWEN_CSV   = REPO_DIR / "llm_bill_VT27_merged_sample5000_06_29_qwen.csv"
META_CSV   = SCRIPT_DIR / "INPUT" / "SAMPLE_5000" / "llm_input_metadata_no_prefilter.csv"
TEXT_DIR   = SCRIPT_DIR / "INPUT" / "SAMPLE_5000" / "llm_input_texts_no_prefilter"
PROMPT_MD  = REPO_DIR / "8_llm_categorize_VT27_bills_prompt_06_29.md"
OUTPUT_CSV = SCRIPT_DIR / "OUTPUT" / "llm_bill_VT27_compare_06_29.csv"
CHECKPOINT = SCRIPT_DIR / "OUTPUT" / "compare_06_29_checkpoint.csv"
